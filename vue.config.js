...
const name = defaultSettings.title || 'dk-planformv.1' // page title
...
module.exports = {
   ...
   */
  publicPath: process.env.NODE_ENV === 'production' ? '/dk-planform/' : '/',
  assetsDir: 'static',
  ...
  devServer: {
    ...
    proxy: {
      ...
      [process.env.VUE_APP_BASE_API]: {
        ...
        //target: `http://varcnc.natappfree.cc/`,
        target: `https://zs.dukevalve.com/duke`,
